                        ...
                        for (let key in morningData) {
                            ...
                            if (key != "__EMPTY") {
                                ...
                                res.forEach((item) => {
                                    ...
                                    let name = resData[1].slice(0, resData[1].indexOf("（"));

                                    let info = resData[1].slice(resData[1].indexOf("（") + 1, resData[1].indexOf("）"));
        ...
        filterChanel(channelName, obj) {
            ...
            if (channelName != undefined) {
                if (channelName.includes("BOSS")) {
                    ...
                    channelId = "zhaopin";
                    channelName = "智联招聘";
                } else if (channelName.includes("建筑英才网") && channelName.includes("搜索")) {
                ...
                } else if (channelName.includes("前程无忧") && channelName.includes("搜索")) {
                    channelId = "51jobSearch";
                    channelName = "前程无忧(搜索)";
                } else if (channelName.includes("前程无忧")) {
                    channelId = "51jobDeliver";
                    channelName = "前程无忧(投递)";
                } else if (channelName.includes("双选会") || channelName.includes("校招")) {
                    channelId = "doubleElection";
                    channelName = "双选会";
                } else if (channelName.includes("邮箱") || channelName.includes("自荐")) {
                    channelName = "邮箱投递";
                ...
                } else if (channelName.includes("内推") || channelName.includes("内部推荐")) {
                    channelName = "内部推荐";
